...
export const JUDGING_CRITERIA = [
  {
    ...
    description:
      'the candidate report mentions a finding (e.g., a mass, calcification, asymmetry) that is not in the ground truth report.',
  },
  {
  ...
  },
  {
    ...
    description:
      'A finding is present in both the ground truth and candidate report, but its characteristics (e.g., size, margins, stability/interval change) are described incorrectly.',
  },
  {
